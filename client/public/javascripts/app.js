...
var Menu, MenuView, Playlist, PlaylistList;
...
module.exports = Menu = (function() {
  Menu.prototype.currentPlaylist = null;
  ...
  Menu.prototype.createNewPlaylist = function() {
    console.log('plop');
    return this.currentPlaylist = new Playlist;
  };
